...
class PaymentController extends Controller
{
    ...
    public function go_to_cart(Request $request,$lang)
    { 
    ...
    { 
         ...
         if(@$request->token != ""){ 
            ...
            if($request->currency =="USD" || $request->currency =="GBP" || $request->currency =="EUR" ){
        ...
        if (isset($_GET['test'])) {
            ...
            if($results){
                $str = $results['match_name'];

                $teams = explode("vs", $str);
            ...
            $response = Http::withHeaders([
                ...
                'X-Shopify-Storefront-Access-Token' => 'af5942d3bf24d694a560b8d2507ac263',
            ])->post('https://thefootballautograph.myshopify.com/api/2023-10/graphql.json', [
                'query' => $query,
            ]);
        ...
        if($results){
            ...
            $footer_disable = 1;
            return view('frontend.payment.checkout',compact('results','country','cartId','title','description','states','match_details','mobile','footer_disable'));
        }
        else{
...
public function updateadyenresp(Request $request,$lang){
    ...
    { 
        ...
        // if(get_client_ip() == "14.142.182.126"){
            ...
            'store_id'   => 13
              ...
              //  echo 'payment_price = '.$payment_price;exit;
               ...
               // echo $t->getMessage(), " at ", $t->getFile(), ":", $t->getLine(), "\n";exit;
                ...
                $response = ["booking_id" =>$response['booking_id'],"booking_no" => $response['booking_no'],"sessionData" => $result['sessionData'],"sessionid" => $result['id'],"tournament" => $booking['tournament_id'],"payment_url" => $payment_url,'payment_method' => PAYMENT_METHOD,'status' => 1];
                return response($response, 200);
                }
