                    ...
                    <div class="onebox-checkout-form-order-details">
                        ...
                        <form>
                          <div class="row checkout-form">
                            <div class="col-md-7 col-sm-7 col-xs-6 full_widd vl">
                                <div class="place_order-details">
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8 col-xs-8">
                                            <div class="order-detail-txt">
                                <a href="{{url(app()->getLocale().'/')}}/{{$results['slug']}}">   
                                        @if(@$results['team_name_a'])
                                         <h4>{{$results['team_name_a']}} <span>VS</span> {{$results['team_name_b']}}</h4></a>
                                         @else
                                         <h4>{{$match_details[0]}} <span>VS</span> {{$match_details[1]}}</h4></a>
                                         @endif
                                               <p><span>{{$results['match_day']}} {{$results['match_date']}} {{$results['match_time'] ?", ". $results['match_time'] : ""}}</span></p>
                                               @if(@$results['team_name_a'])
                           ...
                           <!--  <div class="col-md-1">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-6 full_widd padfive">
                                <div class="place_order-details-code">
                                 ...
                                 @if(@$results['coupon_stauts'] == 1) 
                                <div class="apply_coupoun" id="apply_coupoun">
                                    <label>
                                    <input placeholder="Promo Code" type="text" id="booking_coupon" name="apply_coupoun" value="">
                                    <button id="submit_coupon" type="button">{{__('messages.coupon_submit')}}</button>
                                    </label>
                                    @if($results['coupon_code'])
                                    <p>{{$results['coupon_code']}} Applied. <a href="javascript:void(0)" id="remove_coupon">Remove</a></p>@endif
                                </div>
                                 @endif
                            </div>
                        </div>
                   ...
                   @if(Session::get('user_token') =="")
                    ...
                    <div class="payment-order-details">
                        ...
                        <div class="row checkout-form">
                            ...
                            <div class="col-md-4 col-sm-5 col-xs-6 full_widdh">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-5 col-xs-6 full_widdh">
                                <div class="form-group">
                        ...
                        <div class="row checkout-form">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 full_widdh">
                                <div class="form-group">
                                    <label for="code">{{__('messages.postcode')}}<span class="text-danger">*</span></label>
                        ...
                        <div class="row checkout-form">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 full_widdh">
                                <div class="form-group">
                                    <label for="email">{{__('messages.e-mail')}}<span class="text-danger">*</span></label>
                   ...
                   <div class="our_partners">
                    <h4>{{__('messages.our partners')}}</h4>
                       <div class="partner_image"> 
                        ...
                        <div class="partner_image_pay"> 
                            <img class="img-responsive images" src="{{asset('/')}}/public/img/our_partners/visapng.png">
                            <img class="img-responsive images" src="{{asset('/')}}/public/img/our_partners/master_cards.png">
                            <img class="img-responsive images" src="{{asset('/')}}/public/img/our_partners/apple_pay.png">
                        </div>
                   </div>

                   <div class="clearfix"></div>

                   <!-- <div class="our_partners_pay">
                       <div class="partner_image_pay"> 
                            <img class="img-responsive images" src="{{asset('/')}}/public/img/our_partners/visapng.png">
                            <img class="img-responsive images" src="{{asset('/')}}/public/img/our_partners/master_cards.png">
                            <img class="img-responsive images" src="{{asset('/')}}/public/img/our_partners/apple_pay.png">
