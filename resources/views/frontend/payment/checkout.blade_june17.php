...
<!-- Breadcromb Area End -->
 ...
 <section class="onebox-checkout-area section_20 ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8 col-xs-8">
                                            <div class="order-detail-txt">
                                                <a href="{{url(app()->getLocale().'/')}}/{{$results['slug']}}"><h4>{{$results['team_name_a']}} <span>VS</span> {{$results['team_name_b']}}</h4></a>
                                        ...
                                        <div class="col-md-4">
                                            <div class="ticket_reserved">
                                              @if(@$results['ticket_type_image'])
                                                <p> <i class="fas fa-check-circle"></i>  {{$results['ticket_type_name']}}</p>
      ...
      @endif
                ...
                <div class="col-md-4">
                   <div class="tickets_reserved hidden-xs">
