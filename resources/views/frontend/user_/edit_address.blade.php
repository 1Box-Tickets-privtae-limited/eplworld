                            ...
                            <div class="">
                                ...
                                <div class="row seller-form mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" placeholder="{{__('messages.title')}}" id="title" name="address_title" id="address_title"  value="{{$results['title']}}" required>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    var req_dail_code = document.querySelector("#edit-dialing-code");
