    ...
    <section class="onebox-about-area section_50">
        <div class="container">
            <div class="onebox-about-right">
                ...
                <div class="row">
                            @if($top_matchs_oe)
                        @foreach($top_matchs_oe as $list)
                            <div class="col-md-6 col-sm-6 col-xs-12 full_widdh">
                        <div class="other_event_match">
                            <div class="other_event_img">
                                <img src="{{$list['event_image']}}" alt="{{$list['match_name']}}">
                            </div>
                            <div class="other_event_details_match">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="other_event_matc_texts">
                                                <p><span>{{$list['match_date']}}<span></span></span></p>  
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 padd_mobile_new">
                                            <div class="upcoming-match-btn">
                                               ...
                                               <a href="{{url(app()->getLocale()).'/other-events-'.$list['slug']}}" class="onebox-btn">{{__('messages.book now')}}</a>
                                                @else
                                                 <a class="onebox-btn" href="javascript:void(0)" data-url="{{url(app()->getLocale()).'/other-events-'.$list['slug']}}" onClick="requestNow({{$list['m_id']}},'{{date('Y-m-d',strtotime($list['match_date']))}}','{{$list['match_time']}}')">{{__('messages.request now')}}</a>
                                                 @endif
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-6 padd_mobile">
                                                    <div class="ticket_prices">
                                                      ...
                                                      @if($list['min_price'])  <h4>
                                                        <a href="{{url(app()->getLocale()).'/'.$list['slug']}}">
                                                            {{__('messages.tickets')}} {{__('messages.from')}}  <span class="dir_left"><span class="span_ltr">{{$list['currency_symbol'].' '.$list['min_price']}} </span></span> </a></h4>@endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-6 padd_mobile_new">
                                                    <div class="upcoming-match-btn">
                        ...
                        <div class="last-match-result-one last-match-result">
                                <div class="result-details">
                                    <div class="last-match-logo">
                                        <a><img src="{{$upcoming['team_image_a']}}" alt="{{$upcoming['team_name_a']}}" /></a>
                   ...
                   <!--  <div id="clockdiv">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-3">
                        <div class="last-match-result-one last-match-result">
                                <div class="result-details">
                                    <div class="last-match-logo">
                                        <a><img src="{{$upcoming['team_image_b']}}" alt="{{$upcoming['team_name_b']}}" /></a>
                                            <h3 class="result-details-left">
    ...
    <section class="onebox-upcoming-mathces-area section_50">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 full_widdh">
                    <div class="top_teams">
                                    ...
                                    <div class="single-match-gallery-text">
                                          @if($list['total_match'] > 0)
                                           ...
                                           @if($list['ticket_available'] > 0)  
                                            <p><span><span class="span_ltr">{{$list['ticket_available']}}</span> {{ $list['ticket_available']  > 1 ? __('messages.tickets listed') :  __('messages.ticket listed')}}</span></p>
                                            @endif
                                            @endif
                                    </div>
                                </span>
